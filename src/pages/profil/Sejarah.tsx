        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            <main className="flex-1 space-y-10">
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                  <div className="lg:w-2/5">
                    <div className="relative rounded-xl overflow-hidden">
                      <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=800&q=80" alt="BAKTI Building" className="w-full h-48 lg:h-64 object-cover" />
                      <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-background to-transparent">
                        <span className="text-primary text-sm font-semibold">BAKTI KOMDIGI</span>
                      </div>
                    </div>
                  </div>
              ...
              {/* Detail Content */}
              <article className="space-y-6 animate-fade-up" style={{
              animationDelay: "400ms"
                ...
                <div className="glass rounded-2xl p-6 lg:p-8">
                  ...
                  <ul className="space-y-2">
                    {["Melaksanakan pengelolaan pembiayaan Kewajiban Pelayanan Universal", "Penyediaan infrastruktur telekomunikasi dan informatika", "Memperkecil kesenjangan digital antara wilayah perkotaan dan pedesaan", "Melayani kebutuhan TIK masyarakat Indonesia"].map((item, index) => <li key={index} className="flex items-start gap-3 text-muted-foreground">
